...
Public Class Report_Data_Kasir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_Informasi_Restoran.Report Data Kasir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Data_Kasir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Data_Kasir = New Report_Data_Kasir()
        rpt.Site = Me.Site
        Return rpt
    End Function

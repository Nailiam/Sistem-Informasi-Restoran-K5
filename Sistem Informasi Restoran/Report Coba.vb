...
Public Class Report_Coba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_Informasi_Restoran.Report Coba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Coba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Coba = New Report_Coba()
        rpt.Site = Me.Site
        Return rpt
    End Function

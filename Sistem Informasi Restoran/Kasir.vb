Public Class Kasir
    ...
    Private Sub btn_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_save.Click
        If txt_id.Text = "" Or txt_nama.Text = "" Or cmb_jeniskelamin.Text = "" Or txt_tempatlahir.Text Or txt_agama.Text Or txt_notelp.Text Or txt_alamat.Text Or cmb_status.Text Then
        ...
        Else
            ...
            If Not DM.HasRows Then
               ...
               "', '" & txt_nama.Text & "', '" & cmb_jeniskelamin.Text & "', '" & txt_tempatlahir.Text & "', '" & txt_agama.Text & "', '" & txt_notelp.Text & "', '" & txt_alamat.Text & "', '" & cmb_status.Text & "')"
    ...
    Private Sub DataGridView1_CellMouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.CellMouseClick
        ...
        txt_agama.Text = DataGridView1.Rows(e.RowIndex).Cells(5).Value
    ...
    Private Sub btn_edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_edit.Click
        ...
        Else
           ...
           txt_nama.Text & "', Jenis_Kelamin = '" & cmb_jeniskelamin.Text & "', Tempat_Lahir = '" & txt_tempatlahir.Text & "', Tanggal_Lahir = '" & DateTimePicker1.Format & "', Agama = '" & txt_agama.Text & "', No_Telepon = '" & txt_notelp.Text & "', Alamat = '" & txt_alamat.Text & "', Status = '" & cmb_status.Text & "'", Conn)
            DM = CMD.ExecuteReader
